layui.use(['table','layer'],function(){
    ...
    var  tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'roleName', title: '职位名', minWidth:50, align:"center"},
            {field: 'roleRemark', title: '职位备注', minWidth:100, align:'center'},
    ...
    table.on('tool(roles)', function(obj){
        ...
        if(obj.event === 'del'){
            layer.confirm('真的删除行么', function(index){
                ...
                $.post(ctx+"/role/delete",{"roleId":data.id},function(result){
                    if(result.code==200){
